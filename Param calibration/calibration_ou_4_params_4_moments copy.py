...
def loss_function(params):
    ...
    n_sim_log_price = n_ou_simulation(
        random_seed=randseed2, num_sim=num_sim
        mu11=mu11, mu12=mu12, mu21=mu21, mu22=mu22,
        sigma11=sigma11, sigma12=sigma12, sigma21=sigma21, sigma22=sigma22,
        xinit=xinit)
...
""" the following result is the same as in R n_sim_trend_ou.R"""
n_sim_ou_log_price = n_ou_simulation(
    random_seed=9868, num_sim=248,
    mu11=3, mu12=2, mu21=4, mu22=1, sigma11=2, sigma12=1, sigma21=2, sigma22=1,
    xinit=[2, 3], T0=0, T=1, length=200)
n_sim_ou_price = log_price_to_price(n_log_price=n_sim_ou_log_price)
n_sim_ou_return = price_to_return(n_price=n_sim_ou_price)



n_sim_ou_stats = cal_stats(n_return=n_sim_ou_return, n_price=None)
