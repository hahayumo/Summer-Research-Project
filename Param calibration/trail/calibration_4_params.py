...
# --------------------------------------------------------------------------------
def one_bjd_simulation(theta11=5, theta12=2, theta21=5, theta22=2,
                       p1=2, p2=0.5, p3=1, p4=1, j1=1, j2=2, j3=4, j4=1,
                       x0=[2, 4], random_seed=9868):
...
def n_bjd_simulation(random_seed, theta11=5, theta12=1, theta21=5, theta22=1,
                     p1=2, p2=0.5, p3=1, p4=1, j1=1, j2=0.5, j3=1, j4=1,
                     x0=[2, 4], n_sim=248):
...
def loss_function(params):
    ...
    n_sim_log_price = n_bjd_simulation(
        ...
        theta11=params[0], theta12=params[1], theta21=params[2], theta22=params[3],
        p1=p1, p2=p2, p3=p3, p4=p4, j1=j1, j2=j2, j3=j3, j4=j4,
        x0=x0, n_sim=num_sim)
...
# --------------------------------------------------------------------------------
[theta11, theta12, theta21, theta22] = [5, 2, 5, 2]
[p1, p2, p3, p4, j1, j2, j3, j4] = [2, 0.5, 1, 1, 1, 2, 4, 1]
x0 = [3, 4]
# --------------------------------------------------------------------------------
...
initial = [1, 1, 1, 1]
res = minimize(loss_function, x0=initial, method='Nelder-Mead', tol=1e-6, options={'disp': True, 'maxiter': 50})
res.x
