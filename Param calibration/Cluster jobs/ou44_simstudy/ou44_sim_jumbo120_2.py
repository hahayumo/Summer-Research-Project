...
def loss_function(params):
    ...
    randseed = np.random.randint(low=0, high=100442, size=(1,))
...
np.random.seed(9868)
num_iter = 120
random_seeds_iters = np.random.randint(low=0, high=44102, size=(num_iter,))
random_seeds_sims = np.random.randint(low=0, high=44112, size=(num_iter,))
initial0 = [1, 1, 1, 1]
...
pd.DataFrame(result).to_csv("ou44_sim_jumbo120_2_result.csv")
