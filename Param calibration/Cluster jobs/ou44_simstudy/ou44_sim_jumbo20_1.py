...
def loss_function(params):
    ...
    randseed = np.random.randint(low=0, high=100441, size=(1,))
...
np.random.seed(9868)
num_iter = 20
random_seeds_iters = np.random.randint(low=0, high=44101, size=(num_iter,))
random_seeds_sims = np.random.randint(low=0, high=44111, size=(num_iter,))
initial0 = [1, 1, 1, 1]
...
pd.DataFrame(result).to_csv("ou44_sim_jumbo20_1_result.csv")
