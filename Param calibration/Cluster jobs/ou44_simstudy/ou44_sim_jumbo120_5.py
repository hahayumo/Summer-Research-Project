...
def loss_function(params):
    ...
    randseed = np.random.randint(low=0, high=100445, size=(1,))
...
np.random.seed(9868)
num_iter = 120
random_seeds_iters = np.random.randint(low=0, high=44105, size=(num_iter,))
random_seeds_sims = np.random.randint(low=0, high=44115, size=(num_iter,))
initial0 = [1, 1, 1, 1]
...
pd.DataFrame(result).to_csv("ou44_sim_jumbo120_5_result.csv")
