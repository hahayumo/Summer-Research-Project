...
def loss_function(params):
    ...
    randseed = np.random.randint(low=0, high=100884, size=(1,))
...
np.random.seed(9868)
num_iter = 120
random_seeds_iters = np.random.randint(low=0, high=88104, size=(num_iter,))
random_seeds_sims = np.random.randint(low=0, high=88114, size=(num_iter,))
