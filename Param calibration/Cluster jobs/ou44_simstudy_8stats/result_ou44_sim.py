...
file_folder_path = "/Users/changmao/Desktop/OneDrive - Imperial College London/InferStat - MSc Summer Project/GitHub/Summer-Research-Project/Param calibration/Cluster jobs/ou44_simstudy/"
file1 = pd.read_csv(file_folder_path+"ou44_sim_jumbo20_1_result.csv", index_col=[0])
file2 = pd.read_csv(file_folder_path+"ou44_sim_jumbo120_2_result.csv", index_col=[0])
file3 = pd.read_csv(file_folder_path+"ou44_sim_jumbo120_3_result.csv", index_col=[0])
file4 = pd.read_csv(file_folder_path+"ou44_sim_jumbo120_4_result.csv", index_col=[0])
file5 = pd.read_csv(file_folder_path+"ou44_sim_jumbo120_5_result.csv", index_col=[0])
