...
mu12, mu22, sigma11, sigma22 = 0.03688579, 0.04047083, -1.41181529, -1.35737122
xinit = [4, 5]
...
np.random.seed(9868)
num_iter = 250
random_seeds = np.random.randint(low=0, high=44002, size=(num_iter,))
initial0 = [1, 1, 1, 1]
...
pd.DataFrame(resx_vec).to_csv("ou44_real_medium2_resx_vec.csv")
pd.DataFrame(time_vec).to_csv("ou44_real_medium2_time_vec.csv")
pd.DataFrame(loss_vec).to_csv("ou44_real_medium2_loss_vec.csv")
pd.DataFrame(result).to_csv("ou44_real_medium2_result.csv")
