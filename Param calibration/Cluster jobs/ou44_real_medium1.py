...
np.random.seed(9868)
num_iter = 250
random_seeds = np.random.randint(low=0, high=44001, size=(num_iter,))
initial0 = [1, 1, 1, 1]
...
pd.DataFrame(resx_vec).to_csv("ou44_real_medium1_resx_vec.csv")
pd.DataFrame(time_vec).to_csv("ou44_real_medium1_time_vec.csv")
pd.DataFrame(loss_vec).to_csv("ou44_real_medium1_loss_vec.csv")
pd.DataFrame(result).to_csv("ou44_real_medium1_result.csv")
