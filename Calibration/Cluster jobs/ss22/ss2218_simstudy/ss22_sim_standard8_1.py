...
def loss_function(params):
    ...
    n_real_price = n_stvol_simulation(
    ...
    n_real_stats = cal_stats(n_return=n_real_return, n_price=n_real_price)
...
mu11, mu21, mu22, mu31, mu41, mu42 = 0.26222544, 2.96284705, 2.79633061, -0.28927212, 0.71695055, 4.42044188
sigma11, sigma12, sigma13, sigma14 = 0.26124088, 0.34270097, 0.24891787, 0.09048606
sigma21, sigma22, sigma23, sigma24 = 0.46810189, 0.70773396, 0.48192585, 0.81895315
sigma31, sigma32, sigma33, sigma34 = 0.76085335, 0.26146841, 0.62789311, 0.60658349
sigma41, sigma42, sigma43, sigma44 = 0.40349568, 0.59526509, 0.15285195, 0.55066164
...
pd.DataFrame(result).to_csv("stvol98_sim_standard8_1_result.csv")
