...
n_sim_ou = function(random_seed, num_sim,
  ...
  diffusion = matrix(c("exp(sigma11)*X1", "exp(sigma12)*X2", "exp(sigma21)*X1", "exp(sigma22)*X2"), 2, 2, byrow=TRUE)
...
pd.DataFrame(result).to_csv("gbm44_jumbo50_1_result.csv")
